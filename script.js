vketik1=kalimat.innerHTML;kalimat.innerHTML = "";
  ...
  function ftmuncul(){if(ftganti==0){fotoakhir.style="display:inline-flex;transition:all 0s ease;opacity:1;transform:scale(1)";}else{fotoakhir.src = fotoakhir3.src;fotoakhir.style="display:inline-flex;opacity:1;transition:all .7s ease;transform:scale(1);padding:10px;";}}
  ...
  var aa=0,vketik1;
function mulaiketik1() {kalimat.style="margin-left:65px;margin-right:65px";wallpaper.style="transform: scale(1.5);";if(aa<vketik1.length){kalimat.innerHTML += vketik1.charAt(aa);aa++;setTimeout(mulaiketik1,47);}}

var ab=0,vketik1b;
function fmulaiketik1b(){wallpaper.style="transform: scale(1);";fotoakhir.src=fotoakhir1.src;kalimat.innerHTML="";}
function mulaiketik1b() {if(ab<vketik1b.length){kalimata.innerHTML += vketik1b.charAt(ab);ab++;setTimeout(mulaiketik1b,45);}}
  
  var ac=0,vketik2;
function fmulaiketik2(){wallpaper.style="transform: scale(1.5);";fotoakhir.src=fotoakhir2.src;}
function mulaiketik2() {if(ac<vketik2.length){kalimatb.innerHTML += vketik2.charAt(ac);ac++;setTimeout(mulaiketik2,45);}}

var ad=0,vketik3;
function fmulaiketik3(){wallpaper.style="transform: scale(1);";}
function mulaiketik3() {if(ad<vketik3.length){kalimatc.innerHTML += vketik3.charAt(ad);ad++;setTimeout(mulaiketik3,43);}if(ad==vketik3.length){tombol();}}
  
  function dilanjut(){setTimeout(otomatis2,500);fthilang();ftganti=1;setTimeout(ftmuncul,400);Tombol.style="opacity:0;transform: scale(.1);";jikakuis=1;setTimeout(tombol,1000);}
  ...
  kalimat.style="transition:none;";kalimata.innerHTML="";
  kalimatb.style="display:none";kalimatc.style="display:none";
  }
  function animkata3() {kalimat.innerHTML = kalimat3.innerHTML;kalimatb.innerHTML = kalimatb3.innerHTML;kalimat.style="opacity:1";kalimatb.style="opacity:1;font-size:16px;font-weight:400;transition:none;";}
  ...
  async function diterima(){
      ...
      kalimat.style="";kalimatb.style="";kalimatc.style="";kalimat.style="opacity:0";kalimatb.style="opacity:0";kalimatc.style="opacity:0";
